...
variable = "X"
file = "AMSR2_day_2024"
path = f"/home/ddkovacs/mounted_climers01/home/ddkovacs/Desktop/daytime_validation/{file}.nc"
...
ds = ds[f"SM_{variable}"].attrs({"units": "s"})
compression_settings = {"zlib": True, "complevel": 5}

ds.to_netcdf(
    f"/home/ddkovacs/mounted_climers01/home/ddkovacs/Desktop/daytime_validation/{file}_{variable}_comp_nano.nc",
